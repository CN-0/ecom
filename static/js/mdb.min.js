(jQuery.easing.jswing = jQuery.easing.swing),
            ...
            var x = function () {
                ...
                function t(t) {
                  ...
                  if ("scroll" === T) {
                    var x,
                      k,
                      M,
                      _ = /^x$/i.test(c.axis) ? "Left" : "Top",
                      P = parseFloat(c.offset) || 0;
                    c.container
                      ? p.isWrapped(c.container) || p.isNode(c.container)
                        ? ((c.container = c.container[0] || c.container),
                          (M =
                            (x = c.container["scroll" + _]) +
                            u(r).position()[_.toLowerCase()] +
                            P))
                        : (c.container = null)
                      : ((x =
                          g.State.scrollAnchor[g.State["scrollProperty" + _]]),
                        (k =
                          g.State.scrollAnchor[
                            g.State[
                              "scrollProperty" + ("Left" === _ ? "Top" : "Left")
                            ]
                          ]),
                        (M = u(r).offset()[_.toLowerCase()] + P)),
                      (d = {
                        scroll: {
                          rootPropertyValue: !1,
                          startValue: x,
                    ...
                    for (var I in A)
                      if ("element" !== I) {
                        var $ = A[I].startValue;
                        (A[I].startValue = A[I].currentValue = A[I].endValue),
                          (A[I].endValue = $),
                          p.isEmptyObject(w) || (A[I].easing = c.easing),
                          g.debug &&
                            console.log(
                    ...
                    for (var D in (a(r).tweensContainer &&
                      !0 === a(r).isAnimating &&
                    ...
                    b)) {
                      ...
                      if (
                        a(r).isSVG ||
                        "tween" === H ||
                        !1 !== y.Names.prefixCheck(H)[1] ||
                        y.Normalizations.registered[H] !== n
                      ) {
                        ((c.display !== n &&
                          null !== c.display &&
                          "none" !== c.display) ||
                          ...
                          0 !== R &&
                          (V = 0),
                          c._cacheValues && A && A[D]
                            ? (V === n && (V = A[D].endValue + A[D].unitType),
                              (z = a(r).rootPropertyValueCache[H]))
                            : y.Hooks.registered[D]
                            ? V === n
                              ? ((z = y.getPropertyValue(r, H)),
                                (V = y.getPropertyValue(r, D, z)))
                              : (z = y.Hooks.templates[H][1])
                            : V === n && (V = y.getPropertyValue(r, D));
                        var N,
                          B,
                          j,
                          Y = !1;
                  ...
                  d.element &&
                    ...
                    (a(r).isAnimating = !0),
                    S === C - 1
                      ? (g.State.calls.push([L, v, c, null, O.resolver]),
                        !1 === g.State.isTicking &&
              ...
              if (
                ...
                switch (
                  (d &&
                    g.Promise &&
                    (O.promise = new g.Promise(function (t, e) {
                  ...
                  default:
                    if (!u.isPlainObject(b) || p.isEmptyObject(b)) {
                        ...
                        return (
                          ...
                          u.each(v, function (t, e) {
                            parseFloat(D.stagger)
                              ? (D.delay = A + parseFloat(D.stagger) * t)
                              : p.isFunction(D.stagger) &&
                                (D.delay = A + D.stagger.call(e, t, C)),
                              D.drag &&
                                ((D.duration =
                                  parseFloat(P) ||
                      ...
                      return (
                        O.promise ? O.rejecter(new Error(I)) : console.log(I),
                        t()
                      );
                    }
                    T = "start";
                ...
                if (
                  ...
                  ((D = u.extend({}, g.defaults, w)).loop = parseInt(D.loop)),
                  ($ = 2 * D.loop - 1),
                  D.loop)
                )
                  for (var F = 0; $ > F; F++) {
                ...
                draw: function (t) {
                  ...
                  if (i.display) {
                    var o = e.ctx,
                      ...
                      A =
                        "bottom" === i.position ? e.top + O : e.bottom - w - O,
                      I =
                        "bottom" === i.position ? e.top + O + w : e.bottom + O;
                    if (
                      (a.each(v, function (n, o) {
                        if (!a.isNullOrUndef(n.label)) {
                          ...
                          if (m) {
                            ...
                            H < e.left && (u = "rgba(0,0,0,0)"),
                              (H += a.aliasPixel(c)),
                              (D = e.getPixelForTick(o) + s.labelOffset),
                              (g = y = k = S = H),
                              (b = A),
                              (x = I),
                              (C = t.top),
                            ...
                            s.mirror
                              ? ((F = N ? "left" : "right"), (z = W))
                              : ((F = N ? "right" : "left"), (z = w + W)),
                              (D = N ? e.right - z : e.left + z);
                      ...
                      if (m)
                        ...
                        ($ = F ? e.left + L + S.top : e.right - L - S.top),
                          (D = e.top + (e.bottom - e.top) / 2),
                          (E = F ? -0.5 * Math.PI : 0.5 * Math.PI);
                      }
                      o.save(),
                        o.translate($, D),
                        o.rotate(E),
                    ...
                    if (h.drawBorder) {
                      ...
                      m
                        ? ((V = H = "top" === i.position ? e.bottom : e.top),
                          (V += z),
                          (H += z))
  ...
  (function (t, e) {
      ...
      n = {
        toTextLines: function (t) {
          ...
          for (t = [].concat(t); t.length; )
            "string" == typeof (i = t.pop())
              ? n.unshift.apply(n, i.split("\n"))
              : Array.isArray(i)
              ? t.push.apply(t, i)
              : e.isNullOrUndef(t) || n.unshift("" + i);
          return n;
        },
        ...
        textSize: function (t, e, i) {
          var n,
            ...
            r = t.font,
            s = 0;
          for (t.font = i.string, n = 0; n < a; ++n)
            s = Math.max(t.measureText(o[n]).width, s);
        ...
        arrayDiff: function (t, e) {
          ...
          for (i = 0, o = e.length; i < o; ++i)
            (a = e[i]),
              -1 === (n = r.indexOf(a)) ? s.push([a, 1]) : r.splice(n, 1);
    ...
    function u(t, e, i) {
      var n = a;
      return (
        t < i.left ? (n |= r) : t > i.right && (n |= s),
        e < i.top ? (n |= c) : e > i.bottom && (n |= l),
        n
      );
    }
    function d(t, e) {
        ...
        e.clamp &&
          (a = (function (t, e) {
            for (
              ...
              (i = f || m) & c
                ? ((n = a + ((h - a) * (e.top - d)) / (p - d)), (o = e.top))
                : i & l
                ? ((n = a + ((h - a) * (e.bottom - d)) / (p - d)),
                  (o = e.bottom))
                : i & s
                ? ((o = d + ((p - d) * (e.right - a)) / (h - a)), (n = e.right))
                : i & r &&
                  ((o = d + ((p - d) * (e.left - a)) / (h - a)), (n = e.left)),
                i === f
                  ? (f = u((a = n), (d = o), e))
                  : (m = u((h = n), (p = o), e));
    ...
    var h = {
        ...
        rect: function (t, e) {
          ...
          return (
            t.horizontal
              ? ((n = Math.min(t.x, t.base)), (r = Math.abs(t.base - t.x)))
              : ((a = Math.min(t.y, t.base)), (s = Math.abs(t.base - t.y))),
            d({ x0: n, y0: a + s, x1: n + r, y1: a, vx: i.x, vy: i.y }, e)
          );
        },
    ...
    p.extend(g.prototype, {
      _modelize: function (e, i, o, a) {
        ...
        return {
          ...
          positioner:
            ((r = this._el),
            r instanceof t.elements.Arc
              ? h.arc
              : r instanceof t.elements.Point
              ? h.point
              : r instanceof t.elements.Rectangle
              ? h.rect
              : h.fallback),
      ...
      update: function (t) {
        ...
        u &&
          ((e = t.dataset.data[l]),
          (i = p.valueOrDefault(p.callback(c.formatter, [e, t]), e)),
          (o = p.isNullOrUndef(i) ? [] : n.toTextLines(i)).length &&
            (s = (function (t) {
      ...
      draw: function (t, e) {
        ...
        this.visible() &&
          ...
          a.clip &&
            ((i = a.area),
            o.beginPath(),
            o.rect(i.left, i.top, i.right - i.left, i.bottom - i.top),
            o.clip()),
          (o.globalAlpha = n.bound(0, a.opacity, 1)),
          o.translate(f(e.x), f(e.y)),
          o.rotate(a.rotation),
          (function (t, e, i) {
    ...
    b.extend(S.prototype, {
      ...
      intersects: function (t) {
        ...
        for (
          this._rotation !== t._rotation &&
            r.push(C(a[0], a[1]), C(a[0], a[3])),
            e = 0;
          e < r.length;
          ++e
        )
          if (
            ((i = k(o, r[e])), (n = k(a, r[e])), i.max < n.min || n.max < i.min)
          )
            return !1;
        return !0;
      },
      _points: function () {
        ...
        return [
          w({ x: t.x, y: t.y }, i, e),
          w({ x: t.x + t.w, y: t.y }, i, e),
          w({ x: t.x + t.w, y: t.y + t.h }, i, e),
          w({ x: t.x, y: t.y + t.h }, i, e),
        ];
      },
    });
    var T = {
        ...
        update: function (t) {
          ...
          for (e = 0, i = t.length; e < i; ++e)
            (o = (n = t[e]).model()),
              ((a = n.$layout)._hidable = o && "auto" === o.display),
          ...
          r &&
            (function (t) {
              var e, i, n, o, a, r;
              for (e = 0, i = t.length; e < i; ++e)
                (o = (n = t[e]).$layout)._visible &&
                  ((a = n.geometry()),
                  (r = M(n._el._model, n.model(), a)),
                  o._box.update(r, a, n.rotation()));
              (function (t, e) {
                var i, n, o, a;
                for (i = t.length - 1; i >= 0; --i)
                  for (o = t[i].$layout, n = i - 1; n >= 0 && o._visible; --n)
                    (a = t[n].$layout)._visible &&
                      o._box.intersects(a._box) &&
                      e(o, a);
              })(t, function (t, e) {
                var i = t._hidable,
                  n = e._hidable;
        ...
        lookup: function (t, e) {
          var i, n;
          for (i = t.length - 1; i >= 0; --i)
            if ((n = t[i].$layout) && n._visible && n._box.contains(e))
              return t[i];
          return null;
        },
        draw: function (t, e) {
          ...
          for (i = 0, n = e.length; i < n; ++i)
            (a = (o = e[i]).$layout)._visible &&
              ((r = o.geometry()),
              (s = M(o._el._view, o.model(), r)),
              a._box.update(s, r, o.rotation()),
              o.draw(t, s));
        },
      },
      O = t.helpers,
          ...
          if (O.isObject(t))
            if (O.isNullOrUndef(t.label))
              if (O.isNullOrUndef(t.r))
                for (o = "", n = 0, i = (e = Object.keys(t)).length; n < i; ++n)
                  o += (0 !== n ? ", " : "") + e[n] + ": " + t[e[n]];
              else o = t.r;
            else o = t.label;
          return "" + o;
    ...
    var E = {
      ...
      afterDatasetUpdate: function (t, e, i) {
            ...
            return !1 === a
              ...
              : (!0 === a && (a = {}),
                ...
                (i = r.reduce(function (t, e) {
                  return (
                    P.each(e.listeners || {}, function (i, n) {
        ...
        for (y.save(), n = 0, a = b.length; n < a; ++n)
          if ((((c = b[n])[A] = []), f && c && !c.hidden && !c._model.skip))
            for (o = 0, r = v.labels.length; o < r; ++o)
              (l = (s = v.labels[o])._key),
                ((u = new g(s, y, c, n)).$groups = { _set: d, _key: l || I }),
                (u.$context = {
                  active: !1,
                  chart: t,
                  dataIndex: n,
                ...
                p.push(u);
        y.restore(),
          P.merge(h._listeners, v.listeners, {
      ...
      afterEvent: function (e) {
        ...
        for (i = 0, o = p.length; i < o; ++i)
          if ((s = p[i])[1])
            for (a = 0, r = (c = s[0][A] || []).length; a < r; ++a)
              ((l = c[a]).$context.active = 1 === s[1]), l.update(l.$context);
        (u._dirty || p.length) &&
          (T.update(u._labels),
          (function (e) {
            if (!e.animating) {
              for (
                var i = t.animationService.animations, n = 0, o = i.length;
                n < o;
                ++n
              )
      ...
      i = (function () {
        ...
        return (
          ...
          (i.countRemoveTime = function () {
            var t =
                1e3 * this.$wowElement.css("animation-duration").slice(0, -1),
              e = 0;
            return (
              this.options.duration &&
                (e = t + this.checkOptionsStringFormat(this.options.duration)),
              this.options.delay &&
          ...
          (i.fallback = function () {
            return {
              ...
              or: function (t) {
                return (
                  void 0 !== t && void 0 === this._value && (this._value = t),
                  this
                );
              },
              value: function () {
    ...
    new ((function () {
      ...
      return (
        ...
        (i.toggleActiveClass = function (t, e) {
          var i;
          (e += "Class"),
            (i = t.parent().hasClass("timepicker")
              ? "label"
              : "label, i, .input-prefix"),
            t.siblings(i)[e]("active");
        }),
        ...
        (i.addOnBlurEvent = function () {
          ...
          this.$document.on("blur", this.inputSelector, function (i) {
            ...
            o && a && r && e.toggleActiveClass(n, "remove"),
              !o &&
                a &&
                r &&
                n.siblings("i, .input-prefix").removeClass("active"),
              e.validateField(n);
          });
        }),
            ...
            e.on("blur", function (e) {
              (e.target.type = "text"),
                0 === e.target.value.length &&
                  t("label[for=" + e.target.id + "]").removeClass("active");
            });
        }),
...
function _objectSpread(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? ownKeys(i, !0).forEach(function (e) {
...
$(window).on("load", function () {
  ...
  jQuery(function (t) {
    t("body").attr("aria-busy", !0),
      t("#preloader-markup").load(loader_path, function () {
        windowLoaded
          ? preloaderFading()
  ...
  jQuery(function (t) {
    var e = "ontouchstart" in document.documentElement,
      i = function (t, e) {
        ((e && !t.hasClass("active")) || (!e && t.hasClass("active"))) &&
          (t[e ? "addClass" : "removeClass"]("active"),
    ...
    n.on("mouseenter", function (n) {
      ...
      n.on("click", function (e) {
        var n;
        e.preventDefault(),
          (n = t(e.currentTarget).parent()).hasClass("active")
            ? i(n, !1)
            : i(n, !0);
      }),
      t.fn.extend({
      ...
      return (
        ...
        (i.setMenuWidth = function () {
          ...
          this.$menu.css("width", this.options.menuWidth),
            e.css("width", this.options.menuWidth);
        }),
            ...
            this.$menu.hasClass("fixed") &&
              ...
              t(window).on("resize", function () {
                if (
                  ...
                  window.innerWidth > e.options.breakpoint)
                )
                  e.$sidenavOverlay.length
                    ...
                    : (!1 === e.menuOut &&
                        t(e).trigger("sidenav_open", [e.options.onOpen]),
                      e.$menu.css("transform", "translateX(0%)"),
                      (e.menuOut = !0));
                else if (!1 === e.menuOut) {
                  var i = "left" === e.options.edge ? "-100" : "100";
                  e.$menu.css("transform", "translateX(" + i + "%)"),
                    e.removeMenu(!0);
          ...
          this.$element.on("click", function (i) {
            ...
            t(e).trigger("sidenav_open", [e.options.onOpen]),
              !0 === e.options.showOverlay
                ? t("#sidenav-overlay").length || e.showSidenavOverlay()
                : e.showCloseButton();
            var n = [];
            (n =
              "left" === e.options.edge
        ...
        (i.removeMenu = function (e) {
          ...
          this.$body.css({ overflow: "", width: "" }),
              ...
              { translateX: "left" === this.options.edge ? "-100%" : "100%" },
              {
                ...
                complete: function () {
                  !0 === e &&
                    ...
                    i.$menu.css("width", i.options.menuWidth));
                },
              }
            ),
            ...
            (this.menuOut = !1),
            t(".fixed-sn .double-nav").css("padding-left", "unset"),
            t(".fixed-sn main, .fixed-sn footer").css({ "padding-left": "0" }),
        ...
        (i.touchendEventHandler = function (t) {
          if ("touchend" === t.type) {
            ...
            o > 0 && (o = 0),
              ...
              "left" === this.options.edge
                ? (this.menuOut ||
                  i <= this.settings.menuLeftMinBorder ||
                ...
                : (!this.menuOut || i < this.settings.menuRightMinBorder) &&
                  ...
                  this.translateMenuX(
                    [
                      this.options.menuWidth + this.options.menuVelocityOffset,
                      a,
                    ],
                    "200"
                  ),
        ...
        (i.translateSidenavX = function (t) {
          if ("left" === this.options.edge) {
            ...
            (this.menuOut = e),
              this.$menu.css(
                "transform",
                "translateX(" + (t - this.options.menuWidth) + "px)"
              );
          } else {
            ...
            n < 0 && (n = 0),
              this.$menu.css("transform", "translateX(" + n + "px)");
          }
        }),
      ...
      return (
        ...
        this.each(function () {
          ...
          r.off("click.collapse", ".collapsible-header"),
            ...
            a.accordion || "accordion" === l || void 0 === l
              ? (s.on("click.collapse", function (i) {
                  var a = t(i.target);
                  n(a) && (a = o(a)), a.toggleClass("active"), e(r, a);
                }),
                e(r, s.filter(".active").first()))
              : s.each(function () {
  ...
  jQuery(function (t) {
    ...
    function a(t, e, i, n, o, a, r) {
      t.velocity(
        { height: e, width: i, top: n, marginLeft: o },
        { duration: a, easing: r || "swing" }
      );
    }
    function r(t) {
    ...
    t(document).on("change", e, function () {
      ...
      t(document).on("input mousemove touchmove", ".range-field", function () {
        ...
        n &&
          ...
          o(t(this).children(e), i),
          i.find(".value").html(i.siblings(e).val()));
      }),
  ...
  jQuery(function (t) {
    var e = (function () {
      function e(e, i) {
        void 0 === i && (i = {}),
          (this.$activator = e),
          (this.$activates = t("#" + e.attr("data-activates"))),
          (this.options = {
            inDuration: this.fallback()
              .or(e.data("induration"))
              .or(e.attr("data-in-duration"))
              .or(i.inDuration)
              .or(300)
              .value(),
            outDuration: this.fallback()
              .or(e.data("outduration"))
              .or(e.attr("data-out-duration"))
              .or(i.outDuration)
              .or(225)
              .value(),
            easingEffectIn: this.fallback()
              .or(e.data("easingeffectin"))
              .or(e.attr("data-easing-effect-in"))
              .or(i.easingEffectIn)
              .or("easeOutCubic")
              .value(),
            easingEffectOut: this.fallback()
              .or(e.data("easingeffectout"))
              .or(e.attr("data-easing-effect-out"))
              .or(i.easingEffectOut)
              .or("swing")
              .value(),
            constrainWidth: this.fallback()
              .or(e.data("constrainwidth"))
              .or(e.attr("data-constrain-width"))
              .or(i.constrainWidth)
              .or(!0)
              .value(),
            hover: this.fallback()
              .or(e.data("hover"))
              .or(e.attr("data-hover"))
              .or(i.hover)
              .or(!1)
              .value(),
            gutter: this.fallback()
              .or(e.data("gutter"))
              .or(e.attr("data-gutter"))
              .or(i.gutter)
              .or(0)
              .value(),
            belowOrigin: this.fallback()
              .or(e.data("beloworigin"))
              .or(e.attr("data-below-origin"))
              .or(i.belowOrigin)
              .or(!1)
              .value(),
            alignment: this.fallback()
              .or(e.data("alignment"))
              .or(e.attr("data-alignment"))
              .or(i.alignment)
              .or("left")
              .value(),
            maxHeight: this.fallback()
              .or(e.data("maxheight"))
              .or(e.attr("data-max-height"))
              .or(i.maxHeight)
              .or("")
              .value(),
            resetScroll: this.fallback()
              .or(e.data("resetscroll"))
              .or(e.attr("data-reset-scroll"))
              .or(i.resetScroll)
              .or(!0)
              .value(),
          }),
      ...
      (e.mdbDropdownAutoInit = function () {
        ...
        (e.bindMultiLevelDropdownEvents = function () {
          t(".multi-level-dropdown .dropdown-submenu > a").on(
            "mouseenter",
            function (e) {
              var i = t(this);
              t(
                ...
                i.next(".dropdown-menu").addClass("show"),
                e.stopPropagation();
            }
          ),
            t(".multi-level-dropdown .dropdown").on(
              "hidden.bs.dropdown",
              function () {
                t(".multi-level-dropdown .dropdown-menu.show").removeClass(
                  "show"
                );
              }
            );
        ...
        (e.bindBootstrapEvents = function () {
          ...
          t(".dropdown, .dropup").on({
            ...
            "hide.bs.dropdown": function (i) {
              ...
              a.effectOut &&
                (n || i.preventDefault(),
                e._dropdownEffectStart(o, a.effectOut),
                e._dropdownEffectEnd(o, a, function () {
                  o.removeClass("show"),
        ...
        (e._getDropdownEffects = function (t) {
          ...
          return (
            o.height > 0 &&
              ((e = o.data("dropdown-in") || null),
              (i = o.data("dropdown-out") || null)),
            {
      ...
      return (
        ...
        (i.handleHoverableDropdown = function () {
          ...
          this.$activator.unbind("click." + this.$activator.attr("id")),
            ...
            this.$activator.on("mouseleave", function (n) {
              ...
              t(o).closest(".dropdown-content").is(e.$activates) ||
                (e.$activates.stop(!0, !0), e.hideDropdown(), (i = !1));
            }),
            this.$activates.on("mouseleave", function (n) {
              var o = n.toElement || n.relatedTarget;
              t(o).closest(".dropdown-button").is(e.$activator) ||
                (e.$activates.stop(!0, !0), e.hideDropdown(), (i = !1));
            });
        }),
        ...
        (i.updatePosition = function () {
          ...
          if ("left" === o)
            (a = this.options.gutter),
              (r = this.$activator.position().left + a);
          else if ("right" === o) {
            r =
        ...
        (i._getHorizontalAlignment = function () {
          ...
          return e + this.$activates.innerWidth() > t(window).width()
            ? "right"
            : e - this.$activates.innerWidth() + this.$activator.innerWidth() <
              0
            ? "left"
    ...
    (t.fn.scrollTo = function (e) {
      return (
        this.scrollTop(
          this.scrollTop() - this.offset().top + t(e).offset().top
        ),
        this
      );
    }),
  ...
  return (
    ...
    (e.enableValidation = function () {
      this.view.$nativeSelect.css({
        ...
        -1 ===
          this.view.$nativeSelect.attr("style").indexOf("inline!important") &&
    ...
    (e.buildMaterialOptions = function () {
      ...
      this.view.$nativeSelectChildren.each(function (e, i) {
        ...
        if (n.is("option"))
          ...
          var o = $(
            '<li class="optgroup"><span>' + n.attr("label") + "</span></li>"
          );
      ...
      var i = t.is(":disabled") ? "disabled" : "",
        ...
        d = this.isMultiple
          ? '<input type="checkbox" class="form-check-input" ' +
            ...
            "/><label></label>"
          : "",
        h = t.data("secondary-text")
          ? '<p class="text-muted pt-0 mb-0" disabled>' +
            t.data("secondary-text") +
            "</p>"
          : "";
...
var MaterialSelectView = (function () {
  function t(t, e) {
    ...
    (this.properties = {
      ...
      (this.$toggleAll = $(
        '<li class="select-toggle-all"><span><input type="checkbox" class="form-check-input"><label>' +
  ...
  return (
      ...
      this.$materialSelect.on("focus", function (e) {
        ...
        if (
          ...
          $("ul.select-dropdown")
            ...
            .is(":visible") && $("input.select-dropdown").trigger("close"),
        ...
        .each(function (i, n) {
          $(n).on("click", function (o) {
            ...
            if (!a.hasClass("disabled") && !a.hasClass("optgroup")) {
              var r = !0;
              if (e.isMultiple) {
                a.find('input[type="checkbox"]').prop("checked", function (
                  t,
                  e
                ) {
                  return !e;
                ...
                var s = Boolean(e.$nativeSelect.find("optgroup").length),
                  l =
                    e._isToggleAllPresent() && !e._isPlaceholderPresent()
                      ? a.index() - 1
                      : a.index();
                switch (!0) {
                ...
                e.$materialSelect.val($(c).text().replace(/  +/g, " ").trim()),
                  e.$materialSelect.trigger("close");
              }
              a.toggleClass("active");
              var u = a.attr("aria-selected");
              a.attr("aria-selected", "true" === u ? "false" : "true"),
                e._selectSingleOption(a),
                e.$nativeSelect.data("stop-refresh", !0);
              var d = e._isPlaceholderPresent() ? i + 1 : i;
              e.$nativeSelect.find("option").eq(d).prop("selected", r),
                e.$nativeSelect.removeData("stop-refresh"),
                e._triggerChangeOnNativeSelect(),
    ...
    (e.bindSearchInputKeyup = function () {
      ...
      this.$searchInput.find(".search").on("keyup", function (e) {
        ...
        if (e.which === t.keyCodes.arrowDown || n || o || s)
          return (
            t.$materialSelect.focus(), void t._handleArrowUpDownKey(e.which)
          );
        var l = i.closest("ul"),
          c = i.val(),
    ...
    (e.bindHtmlClick = function () {
      ...
      $("html").on("click", function (e) {
        $(e.target).closest("#select-options-" + t.properties.id).length ||
          $(e.target).hasClass("mdb-select") ||
          !$("#select-options-" + t.properties.id).hasClass("active") ||
          (t.$materialSelect.trigger("close"),
    ...
    (e._handleArrowUpDownKey = function (t) {
      ...
      this._selectSingleOption(i),
        ...
        i.find("input").is(":checked") ||
          i.removeClass(this.options.keyboardActiveClass),
        n.hasClass("selected") ||
    ...
    (e._selectBoundaryOption = function (t) {
      ...
      this._selectSingleOption(e),
        ...
        e.find("input").is(":checked") ||
          e.removeClass(this.options.keyboardActiveClass),
    ...
    (e._handleLetterKey = function (t) {
      ...
      if ((this._removeKeyboardActiveClass(), this.isSearchable)) {
        var i = t.which > 46 && t.which < 91,
          ...
          o = 8 === t.which;
        (i || n) && this.$searchInput.find("input").focus(),
        ...
        (i._onMutationObserverChange = function (e) {
          e.forEach(function (e) {
            ...
            !0 !== i.data("stop-refresh") &&
              ("childList" === e.type ||
                ("attributes" === e.type && t(e.target).is("option"))) &&
              (i.materialSelect({ destroy: !0 }), i.materialSelect());
          });
        }),
            ...
            0 ===
              (e =
                ...
                i > this.options.maxSelectedOptions
                  ? i + " " + this.options.labels.optionsSelected
  ...
  (function () {
    ...
    function M(t, e) {
      ...
      const $ = (t) => {
        ...
        if (((this[i] = e[t].split(":")), 4 === this[i][1].length)) {
          ...
          (this[i][1] = this[i][1].replace(/\D+/g, "")),
            "PM" === t && (this[i][0] = parseInt(this[i][0]) + 12);
        }
        if (2 !== this[i].length) this[i] = null;
        else for (let t = 0; t < this[i].length; t++) this[i][t] = +this[i][t];
      };
      if (
        (e.min &&
          ($("min"),
        ...
        const t = (t) => {
          ...
          "PM" === t && (e = "am"),
            (I.amOrPm = t),
            I.amPmBlock.children(`.${e}-button`).removeClass("active"),
            I.amPmBlock
              .children(`.${t.toLowerCase()}-button`)
              .addClass("active"),
            I.spanAmPm.empty().append(t),
      ...
      var E,
        ...
        F,
        R,
        W = n('<div class="clockpicker-tick"></div>');
      if (e.twelvehour)
        ...
        if (!i || !(f < y - w || f > y + w)) {
          ...
          s && l.append(I.canvas),
            ...
            a.off(h).on(h, function (t) {
              ...
              "PM" === b &&
                (x < 12 && (x = 0), x > 12 && (x -= 12), y > 12 && (y -= 12)),
                I.isInvalidTimeScope
                  ? ((I.isInvalidTimeScope = !1), t.stopPropagation())
                  : "hours" === I.currentView
      ...
      if (
        ...
        B.setAttribute("class", "clockpicker-svg"),
          B.setAttribute("width", k),
          B.setAttribute("height", k);
        var j = f("g");
        j.setAttribute("transform", "translate(" + b + "," + b + ")");
        var Y = f("circle");
        Y.setAttribute("class", "clockpicker-canvas-bearing"),
          Y.setAttribute("cx", 0),
          Y.setAttribute("cy", 0),
          Y.setAttribute("r", 2);
        var q = f("line");
        ...
        X.setAttribute("class", "clockpicker-canvas-bg"),
          X.setAttribute("r", w);
        var U = f("circle");
        U.setAttribute("class", "clockpicker-canvas-fg"),
          U.setAttribute("r", 5),
          j.appendChild(q),
          j.appendChild(X),
          j.appendChild(U),
    ...
    (M.DEFAULTS = {
      ...
      (M.prototype.disableOutOfRangeElements = function () {
        ...
        o &&
          "minutes" === i &&
          (f.removeClass("grey-text disabled"),
          "AM" !== a || t + 12 <= r
            ? "PM" !== a || t >= s || h.addClass("disabled")
            : p.addClass("disabled")),
          o &&
            "PM" === a &&
            (s < 12 && (s = 0), s > 12 && (s -= 12), r > 12 && (r -= 12)),
          o &&
            "hours" === i &&
          ...
          "hours" === i &&
            u.each((t, e) => {
              let i = e.innerHTML;
              this.isTwelvehour && 12 == i && (i = 0),
                i > r || i < s
                  ? n(e).addClass("grey-text disabled")
                  : n(e).removeClass("grey-text disabled");
            }),
          "minutes" === i &&
            d.each((e, i) => {
              s == t && i.innerHTML < c
                ? n(i).addClass("grey-text disabled")
                : r == t && i.innerHTML > l
                ? n(i).addClass("grey-text disabled")
                : n(i).removeClass("grey-text disabled");
            });
      }),
      ...
      (M.prototype.setHand = function (t, e, i, o) {
        ...
        if (c) {
          ...
          if (
            ("PM" === this.amOrPm &&
              (m < 12 && (m = 0), m > 12 && (m -= 12), g > 12 && (g -= 12)),
            this.isTwelvehour && 12 == t && (t = 0),
            t < m || t > g)
          )
            return void (this.isInvalidTimeScope = !0);
          if (this.isTwelvehour && 12 === t)
            return void (this.isInvalidTimeScope = !0);
        } else {
          let { hours: t } = this;
          if (("PM" === k && (t += 12), (t == m && r < b) || (t == g && r > w)))
            return void (this.isInvalidTimeScope = !0);
        }
        if (
          (c
          ...
          this.hand.setAttribute("x2", C),
            this.hand.setAttribute("y2", S),
            this.bg.setAttribute("cx", C),
            this.bg.setAttribute("cy", S),
            this.fg.setAttribute("cx", C),
            this.fg.setAttribute("cy", S);
        } else
      ...
      var s,
        ...
        Qt = {
          ...
          init: function () {
            if (!s && !l) {
              ...
              e && (a.ui = new e(a, o)).init(),
                ...
                void 0 === F && (St("initialLayout"), (F = E = o.getScrollY()));
              var c = "pswp--open ";
              for (
          ...
          updateSize: function (e) {
            ...
            (g = v = a.currItem.initialZoomLevel),
              (J = a.currItem.bounds) &&
                ((ut.x = J.center.x), (ut.y = J.center.y), _t(!0)),
              St("resize");
          },
          ...
          if (
            ...
            if ((Ut(), H || (H = Ae()), H.calculateSwipeSpeed("x"), N))
              ...
              if (!et)
                return "swipe" !== n
                  ? void Ee()
                  : void (!K && v > a.currItem.fitRatio && Ie(H));
            }
        },
        Ae = function () {
          var t,
            ...
            i = {
              ...
              panAnimLoop: function () {
                return jt.zoomPan &&
                  ((jt.zoomPan.raf = I(i.panAnimLoop)),
                  (i.now = Mt()),
        ...
        $e = function (t, e) {
          ...
          return (
            ...
            Kt("mainScroll", ce.x, h, d, o.easing.cubic.out, It, function () {
              Ut(),
                (et = !1),
                (re = -1),
        ...
        Ye = function (t, e, i) {
          if (t.src && !t.loadError) {
            ...
            if (
              ...
              (Ne.x = e.x),
              (Ne.y = e.y - t.vGap.top - t.vGap.bottom),
              n)
            ) {
              var o = Ne.x / t.w,
                a = Ne.y / t.h;
            ...
            return (
              (function (t, e, i) {
                var n = t.bounds;
                (n.center.x = Math.round((Ne.x - e) / 2)),
                  (n.center.y = Math.round((Ne.y - i) / 2) + t.vGap.top),
                  (n.max.x = e > Ne.x ? Math.round(Ne.x - e) : n.center.x),
                  (n.max.y =
                    i > Ne.y ? Math.round(Ne.y - i) + t.vGap.top : n.center.y),
                  (n.min.x = e > Ne.x ? 0 : n.center.x),
                  (n.min.y = i > Ne.y ? t.vGap.top : n.center.y);
              })(t, t.w * i, t.h * i),
              n &&
                ...
                return (
                  r.modal &&
                    (!r.closeOnScroll || Yt || j
                      ? t.preventDefault()
                      : _ && Math.abs(t.deltaY) > 2 && ((c = !0), a.close())),
                  !0
                );
          ...
          k && t.currItem
            ? (x.updateIndexIndicator(),
              v.captionEl &&
                ...
                O(o, "caption--empty", !t.currItem.title)),
              (w = !0))
            : (w = !1),
            C || A(),
            _();
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
  (function (t, e) {
    ...
    function m(t, e, i, n, o) {
      ...
      !(function (t, e, i, n, o) {
        ...
        e &&
          (p.dispatchEvent(f("ps-scroll-" + l)),
          e < 0
            ? p.dispatchEvent(f("ps-scroll-" + d))
            : e > 0 && p.dispatchEvent(f("ps-scroll-" + h)),
          n &&
            (function (t, e) {
              c(t, e), u(t, e);
            })(t, l));
        t.reach[l] &&
          (e || o) &&
          p.dispatchEvent(f("ps-" + l + "-reach-" + t.reach[l]));
      })(t, i, a, n, o);
    }
    function v(t) {
    ...
    function b(t) {
      ...
      (t.containerWidth = Math.ceil(o.width)),
        (t.containerHeight = Math.ceil(o.height)),
        (t.contentWidth = i.scrollWidth),
        (t.contentHeight = i.scrollHeight),
        i.contains(t.scrollbarXRail) ||
          (r(i, s.element.rail("x")).forEach(function (t) {
            return a(t);
          }),
          i.appendChild(t.scrollbarXRail)),
        i.contains(t.scrollbarYRail) ||
          (r(i, s.element.rail("y")).forEach(function (t) {
            return a(t);
          }),
    ...
    function x(t, e) {
      ...
      function x() {
        u(t, h),
          t[p].classList.remove(s.state.clicking),
          t.event.unbind(t.ownerDocument, "mousemove", y);
      }
      function w(e, r) {
        (m = f[d]),
          r && e.touches && (e[o] = e.touches[0].pageY),
          (v = e[o]),
          (g = (t[n] - t[i]) / (t[a] - t[l])),
          r
            ...
            : (t.event.bind(t.ownerDocument, "mousemove", y),
              ...
              e.preventDefault()),
          t[p].classList.add(s.state.clicking),
          e.stopPropagation();
      }
    ...
    var w = {
          ...
          t.event.bind(t.ownerDocument, "keydown", function (i) {
            if (
              ...
              if (a) {
                ...
                if (
                  o((n = a), "input,[contenteditable]") ||
                  o(n, "select,[contenteditable]") ||
                  o(n, "textarea,[contenteditable]") ||
                  o(n, "button,[contenteditable]")
                )
                  return;
              }
              var r = 0,
            ...
            if (
              !(function (e, n, o) {
                ...
                for (var a = e; a && a !== i; ) {
                  ...
                  if (o && r.overflowY.match(/(scroll|auto)/)) {
                    ...
                    if (
                      l > 0 &&
                      ((a.scrollTop > 0 && o < 0) || (a.scrollTop < l && o > 0))
                    )
                      return !0;
                  }
              ...
              e.settings.useBothWheelAxes
                ? e.scrollbarYActive && !e.scrollbarXActive
                  ? (r
                      ? (i.scrollTop -= r * e.settings.wheelSpeed)
                  ...
                  : e.scrollbarXActive &&
                    ...
                    (a
                      ...
                      : (i.scrollLeft -= r * e.settings.wheelSpeed),
                    (l = !0))
                : ((i.scrollTop -= r * e.settings.wheelSpeed),
                  (i.scrollLeft += a * e.settings.wheelSpeed)),
                b(e),
          ...
          if (g.supportsTouch || g.supportsIePointer) {
            ...
            g.supportsTouch
              ? (e.event.bind(i, "touchstart", d),
                e.event.bind(i, "touchmove", h),
                e.event.bind(i, "touchend", p))
              : g.supportsIePointer &&
                (window.PointerEvent
                  ? (e.event.bind(i, "pointerdown", d),
                    e.event.bind(i, "pointermove", h),
                    e.event.bind(i, "pointerup", p))
                  : window.MSPointerEvent &&
                    (e.event.bind(i, "MSPointerDown", d),
                    e.event.bind(i, "MSPointerMove", h),
                    e.event.bind(i, "MSPointerUp", p)));
          }
          function l(t, n) {
                ...
                (function (t, n) {
                  ...
                  if (s > r) {
                    if (
                      ...
                      return 0 === window.scrollY && n > 0 && g.isChrome;
                  } else if (
                    r > s &&
      ...
      k = function (n, o) {
        ...
        (this.isRtl = "rtl" === t(n).direction),
          !0 === this.isRtl && n.classList.add(s.rtl),
        ...
        (this.scrollbarXBottom = parseInt(h.bottom, 10)),
          ...
          (this.railXMarginWidth = v(h.marginLeft) + v(h.marginRight)),
        ...
        (this.scrollbarYRight = parseInt(f.right, 10)),
          ...
          (this.railBorderYWidth =
            v(f.borderTopWidth) + v(f.borderBottomWidth)),
          e(this.scrollbarYRail, { display: "block" }),
          (this.railYMarginHeight = v(f.marginTop) + v(f.marginBottom)),
  ...
  jQuery(function (t) {
    ...
    var e = (function () {
            ...
            "string" == typeof i
              ...
              : {
                  ...
                  secondaryPlaceholder: this.fallback()
                    .or(e.attr("data-secondary-placeholder"))
                    .or(i.secondaryPlaceholder)
                    .or("")
                    .value(),
                  sortAutocompleteData: this.fallback()
                    .or(e.attr("data-sort-autocomplete-data"))
                    .or(i.sortAutocompleteData)
                    .or(!0)
                    .value(),
                  autocompleteDataCompareFn: this.fallback()
                    .or(i.autocompleteDataCompareFn)
                    .or(void 0)
                    .value(),
                }),
          (this.$autocompleteList = t(
      ...
      var i = e.prototype;
      return (
        (i.getSelectedChip = function () {
          return this.$chipsWrapper.find(".chip.selected");
        }),
        (i.returnPublicInterface = function () {
          return "data" === this.options
            ? this.$chipsWrapper.data("chips")
            : "options" === this.options
            ? this.$chipsWrapper.data("options")
            : this.$chipsWrapper;
        }),
        (i.init = function () {
          this.isPublicInterfaceCall ||
            (this.assignOptions(),
            this.isInitialized ||
              ...
              this.$chipsWrapper.hasClass(".chips") ||
        ...
        (i.bindChipsWrapperBlur = function () {
          ...
          this.$chipsWrapper.on("blur", function (i) {
            setTimeout(function () {
              ...
              e.getSelectedChip().removeClass("selected");
          });
        }),
        ...
        (i.bindChipsInputClick = function () {
          ...
          this.$chipsWrapper.find("input").on("click", function (i) {
            t(i.target).addClass("active"),
              e.$chipsWrapper.addClass("focus"),
              e.$chipsWrapper.find(".chip").removeClass("selected");
          });
        }),
        ...
        (i.bindChipsInputKeydown = function () {
          ...
          this.$chipsWrapper.on("keydown", "input", function (i) {
            ...
            if (
              (o || a) &&
              !e.$autocompleteList.find("li").hasClass("selected")
            )
              return (
                i.preventDefault(), e.addChip({ tag: n.val() }), void n.val("")
              );
            if (
              "" === n.val() &&
              r &&
              !e.$chipsWrapper.find(".chip").hasClass("selected")
            ) {
              var s = e.$chipsWrapper
        ...
        (i.bindAutocompleteInputKeyup = function () {
          ...
          i.on("keyup", function (n) {
            var o = i.val();
            e.$autocompleteList.empty(),
              o.length
                ? (e.options.dataChip.forEach(function (i) {
                    i.toLowerCase().includes(o.toLowerCase()) &&
                      e.$chipsWrapper
                        .find(".chip-position-wrapper")
                        .append(
                          e.$autocompleteList.append(t("<li>" + i + "</li>"))
                        );
                  }),
                  e.$autocompleteList.addClass("active").show())
                : e.$autocompleteList.removeClass("active").hide();
            var a = n.which === e.keyCodes.enter,
              ...
              s = e.$chipsWrapper
                ...
                .last()
                .text();
            (!a && !r) || e.options.dataChip.includes(s)
              ? (a || r) && e.$autocompleteList.remove()
              : (e.options.dataChip.push(s),
                e.options.sortAutocompleteData &&
                  e.options.dataChip.sort(e.options.autocompleteDataCompareFn));
          });
        }),
        (i.bindAutocompleteOptionClick = function () {
          ...
          this.$chipsWrapper.on("click", "li", function (i) {
            i.preventDefault();
            var n = t(i.target);
            e.addChip({ tag: n.text() }),
              e.$chipsWrapper
                .find(".chip-position-wrapper")
                .find("input")
                .val(""),
              e.$autocompleteList.remove();
          });
        }),
        (i.deleteSelectedChip = function () {
          ...
          var n = -1;
          return (
            i < e - 1 ? (n = i) : (i !== e && i !== e - 1) || (n = e - 1),
            e || this.$chipsWrapper.find("input").focus(),
            n
          );
        }),
        ...
        (i.selectLeftRightChip = function (t) {
          ...
          if (t && o < 0) o = this.$chipsWrapper.find(".chip").length - 1;
            ...
            return void this.$chipsWrapper.find("input").focus();
        ...
        (i.addChip = function (e) {
          if (this.isValid(e)) {
            ...
            this.$chipsWrapper.data("chips").push(e),
              this.options.data.push(e),
              this.$chipsWrapper.hasClass("chips-autocomplete") &&
              this.$chipsWrapper.find(".chip").length > 0
                ? i.insertAfter(this.$chipsWrapper.find(".chip").last())
                : i.insertBefore(this.$chipsWrapper.find("input")),
              this.$chipsWrapper.trigger("chip.add", e),
              this.setPlaceholder();
          }
        }),
        (i.isValid = function (t) {
          return (
            "" !== t.tag &&
            !this.options.data.some(function (e) {
              return e.tag === t.tag;
            })
          );
        }),
        (i.deleteChip = function (t) {
          ...
          this.$chipsWrapper.find(".chip").eq(t).remove(),
            this.$chipsWrapper.data("chips").splice(t, 1),
            this.options.data.splice(t, 1),
            this.$chipsWrapper.trigger("chip.delete", e),
            this.setPlaceholder();
        }),
        (i.selectChip = function (t) {
          ...
          e &&
            ...
            this.$chipsWrapper.trigger(
              "chip.select",
              this.$chipsWrapper.data("chips")[t]
            ));
        }),
        (i.fallback = function () {
          return {
      ...
      return (
        ...
        (i.setAutocompleteWrapHeight = function () {
          this.$autocompleteWrap.css(
            "max-height",
            45 * this.options.visibleOptions + "px"
          );
        }),
        (i.setData = function () {
        ...
        (i.inputKeyupData = function () {
          ...
          this.$input.on("keyup", function (e) {
            ...
            if ((t.$autocompleteWrap.empty(), i.length)) {
              ...
              e.which === t.homeCharCode && t.homeHandler(n, o),
                e.which === t.endCharCode && t.endHandler(n, o),
                e.which === t.arrowDownCharCode
                  ? t.arrowDownHandler(n, o, a)
                  : e.which === t.arrowUpCharCode &&
                    t.arrowUpHandler(n, o, a, r),
                0 === i.length
        ...
        (i.endHandler = function (t, e) {
          (this.count = e.length - 1),
            (this.nextScrollHeight = 45 * e.length - 45),
            t.scrollTop(45 * e.length),
            e.eq(-1).addClass("selected");
        }),
        (i.homeHandler = function (t, e) {
          (this.count = 0),
            (this.nextScrollHeight = -45),
            t.scrollTop(0),
            e.eq(0).addClass("selected");
        }),
        (i.arrowDownHandler = function (t, e, i) {
          if (this.count > e.length - 2)
            return (
              (this.count = -1),
              e.scrollTop(0),
          ...
          this.count++,
            ...
            t.scrollTop(this.nextScrollHeight),
            e.eq(this.count).addClass("selected");
        }),
        (i.arrowUpHandler = function (t, e, i, n) {
          this.count < 1
            ? ((this.count = e.length),
              t.scrollTop(t.prop("scrollHeight")),
              (this.nextScrollHeight = t.prop("scrollHeight") - i))
            : this.count--,
        ...
        (i.stop = function () {
          this.stopPoint <
            t(this.$element).offset().top -
              ...
              this.$element.outerHeight(!0) &&
            this.$element.css({ position: "absolute", bottom: 0, top: "" });
        }),
        e
      );
    })();
